"""
Test statistical significance of similarity comparison
"""

import numpy as np
from scipy.stats import friedmanchisquare
import pandas as pd
from statistics.similarity_comparison.mapping import map

# each participant ranked 8 cases across 3 diagnosises.
df1 = pd.read_csv("statistics/similarity_comparison/data/ranking_data_participent_1.csv")
df2 = pd.read_csv("statistics/similarity_comparison/data/ranking_data_participent_2.csv")
df3 = pd.read_csv("statistics/similarity_comparison/data/ranking_data_participent_3.csv")
