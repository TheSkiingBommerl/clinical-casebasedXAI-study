...
import io
import pickle
from AI_diagnostic_support.database.useful_queries import get_ecg_signals, get_patient_info, get_diagnostics, get_certainty
from AI_diagnostic_support.database.db_connection import extract_data
from AI_diagnostic_support.similarity_measure.cosine_similarity import get_ref
import os
