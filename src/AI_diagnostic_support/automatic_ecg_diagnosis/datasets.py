"""
Tensorflow dataset class for ECG sequences

This file was copied verbatim from the following repository:
https://github.com/antonior92/automatic-ecg-diagnosis/blob/master/predict.py
"""
