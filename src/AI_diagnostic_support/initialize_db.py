...
from AI_diagnostic_support.signal_filtering.filter_all_signals import filter_ptbxl, filter_from_db
from AI_diagnostic_support.database.transform_and_load.ptb.filter_datafile import filter_ptbxl_entries
import AI_diagnostic_support.database.db_connection as db
from AI_diagnostic_support.database.transform_and_load import code_test as code_test
from AI_diagnostic_support.database.transform_and_load.ptb.initial_load import (
    load_gold_labels,
    load_records
)
...
def main():
    ...
    ptbxl_csv = processed_dir / "filtered_ptbxl.csv"
